...
/**
 * 验证码工具类（近测试用，不另新建util包了）
 * @author Administrator
 */
public class VerifyCodeUtils {

	private static String source = "23456789ZXCVBNMMASDFGHJKLQWERTYUP";
	...
	public static String generateVerifyCode(int verifySize) {
		...
		for (int i = 0; i < verifySize; i++) {
			//生成随机数 取出source对应位置的字符
			verifyCode.append(source.charAt(r.nextInt(slen)));
		}
